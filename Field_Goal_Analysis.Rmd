...
FGdataTableOut <- FGdataTable |>
  ...
  tab_caption(caption = md("Table1: Counts of NFL field goals made and attempted. All kicks since 1999.")) #|>
  #as_raw_html()
...
```{r Posterior Plot, fig.align = "center", out.width="90%"}
## Set parameters ----
...
posteriorSumTable <- posteriorSum |>
  ...
  #opt_vertical_padding(scale = 0.25) |>
  tab_caption(caption = md("Table 2: Posterior summary table for varying priors")) |>
  as_raw_html()
posteriorSumTable
```
...
```{r Likelihood Plot, fig.align = "center", out.width='90%'}
thetaHat0 <- y/n
...
binnedDistProbsTable <- binnedDistProbs |>
  ...
  #opt_vertical_padding(scale = 0.25) |>
  tab_caption(caption = md("Table 3: Hypothesis probability for each binned distance")) |>
  as_raw_html()
